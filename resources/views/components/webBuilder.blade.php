...
<body>
    <div class="card web-builder-bg mx-10 mb-20">
        <div class="flex lg:flex-row flex-col gap-5 justify-center items-center p-5 lg:p-20">
            <div
                ...
                <h1 class="lg:text-7xl lg:leading-tight text-3xl font-extrabold">
            ...
            <div class="w-full lg:w-2/5">
                <img src="{{ asset('assets/graphics/web-builder-bro.png') }}" alt="web builder" />
            </div>
        </div>
    </div>
</body>
